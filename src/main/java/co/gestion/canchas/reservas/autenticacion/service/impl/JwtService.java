...
import co.gestion.canchas.reservas.autenticacion.service.IJwtService;
...
public class JwtService implements IJwtService {
    ...
    public String getToken(UserDetails userDetails) {
        ...
        UserSecurityDTO user = (UserSecurityDTO) userDetails;
        additionalClaims.put(CLAIM_CODIGO_USER, user.getId());
    ...
    public String getIdentificadorFromToken(String token) {
        ...
        if (claims.containsKey(CLAIM_CODIGO_USER)) {
            return claims.get(CLAIM_CODIGO_USER, String.class);
        }
